...
angular.module('starter.services', [])
    ...
    .value('GEOFIRE_REF','https://geolocate.firebaseio.com/')
    .value('userSession',{})
    .value('USER',{})
    ...
    .service('loginCtrl',
        ...
        var doLogin = function () {
            ...
            $rootScope.login = function (provider) {
                ...
                /*userSession.authWithOAuthPopup(provider, function(error, authData) {
                    if (error) {
            ...
            $rootScope.$on('$firebaseSimpleLogin:login', function (event, user) {
                ...
                deferred.resolve($geo.$get(userSession.user.uid));

                //Get list of users & store in localstorage
                var userList = [];
                var tmp1 = SharedData.get().child("users").limit(2);
